"""Run a deterministic grid search for student baseline hyperparameters."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Grid search for student baseline on CIFAR-100")
    parser.add_argument("--model", type=str, default="resnet18_cifar")
    parser.add_argument("--gpu", type=int, default=0)
    parser.add_argument("--epochs", type=int, default=40)
    parser.add_argument("--save_subdir", type=str, default="student_grid", help="Subdirectory inside SAVE_DIR")
    ...
    parser.add_argument("--wandb_tags", type=str, default="student,search,grid")
...
def build_command(args, exp_name: str, cfg: Dict[str, Any], idx: int) -> List[str]:
    ...
    if args.use_wandb:
        ...
        run_group = f"student-grid/{args.model}/{args.campaign_id}/{args.grid_preset}"
